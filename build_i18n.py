...
META = {
    "index.html": {
        ...
        "fa": {
            "title": "هادی کیانی‌راد — بک‌اند، ربات تلگرام و اتوماسیون در استانبول",
            "description": "بک‌اند پایتون، ربات تلگرام و اتوماسیون هوش مصنوعی برای کسب‌وکارها؛ بیش از ۱۴ سیستم در حال اجرا، به فارسی، ترکی و انگلیسی.",
            "og_title": "هادی کیانی‌راد — بک‌اند، ربات و اتوماسیون",
            "og_description": "بک‌اند پایتون، ربات تلگرام و اتوماسیون هوش مصنوعی برای کسب‌وکارها؛ سیستم‌هایی که از کار نمی‌افتند.",
        },
    },
    "projects.html": {
        "tr": {
        ...
        "fa": {
            ...
            "description": "سیستم‌های زنده ساخته‌شده توسط هادی کیانی‌راد: داده بلادرنگ، ربات تلگرام، عملیات صرافی و ابزارهای اعتبارسنجی.",
            "og_description": "سیستم‌های واقعی در حال اجرا: داده بلادرنگ، ربات تلگرام، عملیات صرافی و ابزارهای تولیدی.",
        },
    },
    "consultancy.html": {
        "tr": {
        ...
        "fa": {
            "title": "مشاوره اتوماسیون | هادی کیانی‌راد",
            "description": "مشاوره برای حذف کارهای تکراری با پایتون، ربات تلگرام و اتوماسیون هوش مصنوعی؛ محدوده و قیمت ثابت پیش از شروع مکتوب می‌شود.",
            "og_description": "کار تکراری‌ای را که وقت تیم شما را می‌گیرد پیدا کنید، اتوماسیون مناسب را بسازید و هر هفته نسخه‌ای قابل استفاده ببینید.",
        },
    },
    "about.html": {
        "tr": {
        ...
        "fa": {
            ...
            "description": "هادی کیانی‌راد، مهندس بک‌اند و اتوماسیون در استانبول؛ با سابقه پایتون، مدیریت سیستم، ربات تلگرام و سامانه‌های تولیدی.",
            "og_description": "سابقه هادی کیانی‌راد در بک‌اند، اتوماسیون، پایتون و سیستم‌های تولیدی.",
        },
    },
    "contact.html": {
        "tr": {
        ...
        "fa": {
            ...
            "description": "برای پروژه بک‌اند، ربات تلگرام یا اتوماسیون هوش مصنوعی با هادی کیانی‌راد تماس بگیرید؛ به فارسی، ترکی یا انگلیسی.",
            "og_description": "کاری را که وقت کسب‌وکار شما را می‌گیرد توضیح دهید؛ به فارسی، ترکی یا انگلیسی.",
        },
    },
    "privacy.html": {
        "tr": {
        ...
        "fa": {
            ...
            "description": "توضیح ساده درباره اطلاعات فرم تماس kianirad.website، نحوه استفاده از آن و حقوق مرتبط با داده‌های شخصی.",
            "og_description": "kianirad.website چگونه درخواست‌های تماس و اطلاعات شخصی را پردازش می‌کند.",
        },
    },
    "status.html": {
        "tr": {
        ...
        "fa": {
            "title": "وضعیت سیستم‌ها | هادی کیانی‌راد",
            "description": "وضعیت به‌روز سیستم‌های در حال اجرایی که هادی کیانی‌راد نگهداری می‌کند، همراه با زمان آخرین بررسی.",
            "og_description": "وضعیت سیستم‌های در حال اجرا و زمان آخرین بررسی.",
        },
    },
}
...
BAKE_OVERRIDES = {
    ...
    ("privacy.html", "fa", "rights2"): """برای درخواست مربوط به حریم خصوصی به <a href="mailto:kianirad2020@gmail.com">kianirad2020@gmail.com</a> ایمیل بزنید و توضیح دهید به کدام اطلاعات یا درخواست اشاره می‌کنید. ممکن است برای اطمینان از اینکه به شخص درست پاسخ می‌دهم اطلاعات کافی از شما بخواهم.""",
}
        ...
        "block": """
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "اگر اتوماسیون کار نکند چه؟",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "شرح کار پیش از شروع به‌صورت مکتوب قطعی می‌شود، از جمله اینکه «کار کردن» یعنی چه. اگر چیزی تحویل بدهم که آن را برآورده نکند، با هزینه‌ی خودم درستش می‌کنم. کاری که نمی‌کنم، وعده دادن نتیجه‌ای تجاری است که در کنترل من نیست: تضمین می‌کنم نرم‌افزار درست پاسخ بدهد، نه اینکه بازار شما بیشتر بخرد."
      }
    },
    {
      "@type": "Question",
      "name": "مالکیت چیزی که می‌سازید با من است؟",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "بله. با پرداخت نهایی، کد، داده و حساب‌ها مال شماست. میزبانی شما را گروگان نمی‌گیرم و اگر بروید، بدون دردسر به برنامه‌نویس دیگری تحویل می‌دهم."
      }
    },
    {
      "@type": "Question",
      "name": "از داده‌ی من برای آموزش چیزی استفاده می‌کنید؟",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "نه. محتوای شما فقط برای پیکربندی سیستم خودتان استفاده می‌شود. اگر پروژه داده‌ی مشتری داشته باشد، پیش از شروع دقیقاً می‌گویم کدام سرویس‌های شخص ثالث با آن سروکار دارند تا خودتان تصمیم بگیرید."
      }
    },
    {
      "@type": "Question",
      "name": "صورتحساب چطور و به چه ارزی است؟",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "قیمت قطعی به دلار یا یورو، در دو بخش. مشتریان ترکیه می‌توانند به لیر فاکتور بگیرند. طرح‌های نگهداری ماهانه صورتحساب می‌شوند."
      }
    },
    {
      "@type": "Question",
      "name": "چه کارهایی را قبول نمی‌کنید؟",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "کارهایی که باید با بودجه‌ی شما یاد بگیرم، اپلیکیشن‌های موبایل نیتیو، و پروژه‌هایی که در سمت شما کسی نیست که تصمیم بگیرد. ترجیح می‌دهم شما را به آدم مناسب‌تری معرفی کنم تا کاری متوسط را کند تحویل بدهم."
      }
    }
  ]
}
